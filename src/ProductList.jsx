...
//console.log("usetotalitems ");
  const cart = useSelector(state => state.cart.items);
const totalItems = cart.reduce((sum, item) => sum + item.quantity, 0);
//console.log("usetotalitems= "+totalItems);
  return totalItems;
};
            ...
            <div style={styleObjUl}>
                ...
                <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className='cart'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                       ...
                       <text x="130" y="130" text-anchor="middle" dominant-baseline="middle" fill="black">{totalItems}</text>
                   </svg></h1></a></div>
            </div>
        </div>
        {!showCart? (
